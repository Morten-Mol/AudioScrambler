...
# Frequency shufling function
def shuffle_freqs(band1,band2,width,freqs,freq_amp):
    ### Swap frequencies between first and second band
    ### band1(float): Center frequency in kHz of first band
    ### band2 (float): Center frequency in kHz of second band
...
# According to https://en.wikipedia.org/wiki/Voice_frequency, the voice frequencies goes from around 0.3 to 3.4 kHz. We should therefore focus our shuffling in that area.
